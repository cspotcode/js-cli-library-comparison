...
export default o.command(
  ...
  o.merge(outputParser, o.object({
    action: o.constant('item-archive'),
    ...
    id: o.option('--id', o.string(), { description: o.message`ID of the item to archive` }),
    owner: o.option('--owner', o.string(), { description: o.message`Login of the owner (user or org)` }),
    undo: o.option('--undo', { description: o.message`Unarchive an item` }),
  })),
  { brief: o.message`Archive an item in a project` },
);
